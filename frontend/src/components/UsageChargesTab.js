    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        setFormData(prev => ({
          ...
          'Bill Month': ext.period_from || ext.bill_month || prev['Bill Month'] || '',
          'Bill Date': ext.period_from || ext.bill_date || prev['Bill Date'] || '',
          'Bill Period From': ext.period_from || prev['Bill Period From'] || '',
          'Bill Period To': ext.period_to || prev['Bill Period To'] || '',
