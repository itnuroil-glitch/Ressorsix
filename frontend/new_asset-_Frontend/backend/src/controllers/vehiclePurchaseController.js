...
exports.saveVehiclePurchase = async (req, res) => {
  try {
    ...
    const query = `
      INSERT INTO tbl_vehicle_purchase (vehicle_id, custom_field_id, field_data, clientid, country_id, moduleid, created_at, updated_at)
...
exports.getVehiclePurchase = async (req, res) => {
  try {
    ...
    let query = 'SELECT * FROM tbl_vehicle_purchase';
    const params = [];
    if (clientid) {
